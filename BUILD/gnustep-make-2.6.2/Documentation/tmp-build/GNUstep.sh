...
if [ -z "$GNUSTEP_CONFIG_FILE" ]; then
  GNUSTEP_CONFIG_FILE=/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/GNUstep.conf
else
...
if [ "$GNUSTEP_MAKE_STRICT_V2_MODE" = "yes" ]; then
  ...
  if [ -z "$GNUSTEP_SYSTEM_ROOT" ]; then
    GNUSTEP_SYSTEM_ROOT=/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System
  fi

  # This is deprecated and will be removed
  if [ -z "$GNUSTEP_LOCAL_ROOT" ]; then
    GNUSTEP_LOCAL_ROOT=/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local
  fi

  # This is deprecated and will be removed
  if [ -z "$GNUSTEP_NETWORK_ROOT" ]; then
    GNUSTEP_NETWORK_ROOT=/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Network
  fi
...
if [ -z "$GNUSTEP_MAKEFILES" ]; then
  GNUSTEP_MAKEFILES=/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/Makefiles
fi
