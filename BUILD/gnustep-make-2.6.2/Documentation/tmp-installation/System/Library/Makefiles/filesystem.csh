...
if ( ! ${?GNUSTEP_SYSTEM_APPS} ) then
  setenv GNUSTEP_SYSTEM_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Applications"
endif
if ( ! ${?GNUSTEP_SYSTEM_ADMIN_APPS} ) then
  setenv GNUSTEP_SYSTEM_ADMIN_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Applications/Admin"
endif
if ( ! ${?GNUSTEP_SYSTEM_WEB_APPS} ) then
  setenv GNUSTEP_SYSTEM_WEB_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/WebApplications"
endif
if ( ! ${?GNUSTEP_SYSTEM_TOOLS} ) then
  setenv GNUSTEP_SYSTEM_TOOLS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Tools"
endif
if ( ! ${?GNUSTEP_SYSTEM_ADMIN_TOOLS} ) then
  setenv GNUSTEP_SYSTEM_ADMIN_TOOLS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Tools/Admin"
endif
if ( ! ${?GNUSTEP_SYSTEM_LIBRARY} ) then
  setenv GNUSTEP_SYSTEM_LIBRARY "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library"
endif
if ( ! ${?GNUSTEP_SYSTEM_HEADERS} ) then
  setenv GNUSTEP_SYSTEM_HEADERS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/Headers"
endif
if ( ! ${?GNUSTEP_SYSTEM_LIBRARIES} ) then
  setenv GNUSTEP_SYSTEM_LIBRARIES "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/Libraries"
endif
if ( ! ${?GNUSTEP_SYSTEM_DOC} ) then
  setenv GNUSTEP_SYSTEM_DOC "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/Documentation"
endif
if ( ! ${?GNUSTEP_SYSTEM_DOC_MAN} ) then
  setenv GNUSTEP_SYSTEM_DOC_MAN "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/Documentation/man"
endif
if ( ! ${?GNUSTEP_SYSTEM_DOC_INFO} ) then
  setenv GNUSTEP_SYSTEM_DOC_INFO "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/Documentation/info"
endif
...
if ( ! ${?GNUSTEP_NETWORK_APPS} ) then
  setenv GNUSTEP_NETWORK_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Applications"
endif
if ( ! ${?GNUSTEP_NETWORK_ADMIN_APPS} ) then
  setenv GNUSTEP_NETWORK_ADMIN_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Applications/Admin"
endif
if ( ! ${?GNUSTEP_NETWORK_WEB_APPS} ) then
  setenv GNUSTEP_NETWORK_WEB_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/WebApplications"
endif
if ( ! ${?GNUSTEP_NETWORK_TOOLS} ) then
  setenv GNUSTEP_NETWORK_TOOLS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Tools"
endif
if ( ! ${?GNUSTEP_NETWORK_ADMIN_TOOLS} ) then
  setenv GNUSTEP_NETWORK_ADMIN_TOOLS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Tools/Admin"
endif
if ( ! ${?GNUSTEP_NETWORK_LIBRARY} ) then
  setenv GNUSTEP_NETWORK_LIBRARY "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library"
endif
if ( ! ${?GNUSTEP_NETWORK_HEADERS} ) then
  setenv GNUSTEP_NETWORK_HEADERS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Headers"
endif
if ( ! ${?GNUSTEP_NETWORK_LIBRARIES} ) then
  setenv GNUSTEP_NETWORK_LIBRARIES "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Libraries"
endif
if ( ! ${?GNUSTEP_NETWORK_DOC} ) then
  setenv GNUSTEP_NETWORK_DOC "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Documentation"
endif
if ( ! ${?GNUSTEP_NETWORK_DOC_MAN} ) then
  setenv GNUSTEP_NETWORK_DOC_MAN "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Documentation/man"
endif
if ( ! ${?GNUSTEP_NETWORK_DOC_INFO} ) then
  setenv GNUSTEP_NETWORK_DOC_INFO "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Documentation/info"
endif
...
if ( ! ${?GNUSTEP_LOCAL_APPS} ) then
  setenv GNUSTEP_LOCAL_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Applications"
endif
if ( ! ${?GNUSTEP_LOCAL_ADMIN_APPS} ) then
  setenv GNUSTEP_LOCAL_ADMIN_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Applications/Admin"
endif
if ( ! ${?GNUSTEP_LOCAL_WEB_APPS} ) then
  setenv GNUSTEP_LOCAL_WEB_APPS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/WebApplications"
endif
if ( ! ${?GNUSTEP_LOCAL_TOOLS} ) then
  setenv GNUSTEP_LOCAL_TOOLS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Tools"
endif
if ( ! ${?GNUSTEP_LOCAL_ADMIN_TOOLS} ) then
  setenv GNUSTEP_LOCAL_ADMIN_TOOLS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Tools/Admin"
endif
if ( ! ${?GNUSTEP_LOCAL_LIBRARY} ) then
  setenv GNUSTEP_LOCAL_LIBRARY "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library"
endif
if ( ! ${?GNUSTEP_LOCAL_HEADERS} ) then
  setenv GNUSTEP_LOCAL_HEADERS "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Headers"
endif
if ( ! ${?GNUSTEP_LOCAL_LIBRARIES} ) then
  setenv GNUSTEP_LOCAL_LIBRARIES "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Libraries"
endif
if ( ! ${?GNUSTEP_LOCAL_DOC} ) then
  setenv GNUSTEP_LOCAL_DOC "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Documentation"
endif
if ( ! ${?GNUSTEP_LOCAL_DOC_MAN} ) then
  setenv GNUSTEP_LOCAL_DOC_MAN "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Documentation/man"
endif
if ( ! ${?GNUSTEP_LOCAL_DOC_INFO} ) then
  setenv GNUSTEP_LOCAL_DOC_INFO "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local/Library/Documentation/info"
endif
