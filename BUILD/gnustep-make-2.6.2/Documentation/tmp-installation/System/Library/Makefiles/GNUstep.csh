...
if ( ! ${?GNUSTEP_CONFIG_FILE} ) then
  setenv GNUSTEP_CONFIG_FILE "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/GNUstep.conf"
else
...
if ( "${GNUSTEP_MAKE_STRICT_V2_MODE}" == "yes" ) then
  ...
  if ( ! ${?GNUSTEP_SYSTEM_ROOT} ) then
    setenv GNUSTEP_SYSTEM_ROOT "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System"
  endif

  if ( ! ${?GNUSTEP_LOCAL_ROOT} ) then
    setenv GNUSTEP_LOCAL_ROOT "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Local"
  endif

  if ( ! ${?GNUSTEP_NETWORK_ROOT} ) then
    setenv GNUSTEP_NETWORK_ROOT "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/Network"
  endif
...
if ( ! ${?GNUSTEP_MAKEFILES} ) then
  setenv GNUSTEP_MAKEFILES "/home/bero/abf/gnustep-make/BUILD/gnustep-make-2.6.2/Documentation/tmp-installation/System/Library/Makefiles"
endif
...
if ( "" == "" ) then
  setenv GNUSTEP_HOST "x86_64-unknown-linux-gnu"
